...
<body>
	...
	<script type = "text/javascript">
		...
		if (status == "success"){
			swal("Congrats", "Your Account has been successfully created", "success");
		}
		if (status == "Enter Your Name"){
			swal("Sorry", "Please Enter Your Name", "error");
		}
		if (status == "Enter Your Email"){
			swal("Sorry", "Please Enter Your Email", "error");
		}
		if (status == "Enter Your Password"){
			swal("Sorry", "Please Enter Your Password", "error");
		}
		if(status == "InvalidConfirm Password")){
			swal("Sorry", "Passwords do not match", "error");
		}
		if (status == "Enter Your Phone Number"){
			swal("Sorry", "Please Enter Your Phone Number", "error");
		}
		if (status == "Invalid Phone No. Length"){
			swal("Sorry", "A Phone Number can only have 10 digits", "error");
		}
	</script>
